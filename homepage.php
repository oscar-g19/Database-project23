...
<html>
  ...
  <body>
    ...
    <button onclick="location.href='loanpay.php'">Make Loan Payment</button>
    <button onclick="location.href='loan.php'">Set Up Loan</button>
	<button onclick="location.href='budget.php'">Create Budget</button>
	<button onclick="location.href='history.php'">Spending History</button>
